...
public class SimpleLetterAndNumberGenerator implements ICaptcha {

    private static SimpleLetterAndNumberGenerator simpleLetterAndNumberGenerator;

    private final static Logger logger = LoggerFactory.getLogger(SimpleLetterAndNumberGenerator.class);
    ...
    private SimpleLetterAndNumberGenerator() {

    }

    public static SimpleLetterAndNumberGenerator getInstance() {
        if (simpleLetterAndNumberGenerator == null) {
            simpleLetterAndNumberGenerator = new SimpleLetterAndNumberGenerator();
        }
        return simpleLetterAndNumberGenerator;
    }
    ...
    public Captcha generateCaptcha(int size, int width, int height, float fontSize) {
        ...
        try {
            ...
            LineUtil.draw2Line(g, true, 1, height, bgColor, charColor);
        } catch (Exception e) {
