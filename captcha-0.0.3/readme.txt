...
2、在验证码页面链接 captchaImage文件夹里面的js和css（captchaImage在源代码src/test/resources里面，jar里面不会出现）
<link rel="stylesheet" href="js/captchaImage/captcha.css" type="text/css" />
<script type="text/javascript" src="js/captchaImage/captcha.js"></script>
