...
public class TestImageCaptchaFactory {

    private final static Logger logger = LoggerFactory.getLogger(TestImageCaptchaFactory.class);

    public static void main(String[] args) {

        ICaptcha icaptcha = CaptchaFactory.createCaptchaObject(CaptchaType.CHOOSEIMAGE);
